      ...
      <Section spacing="xl" className="relative overflow-hidden">
        ...
        <Container>
          ...
          <div className="mt-16 relative">
            <div className="aspect-[16/10] max-w-5xl mx-auto rounded-xl bg-foreground/5 border border-foreground/10 overflow-hidden flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <p className="text-foreground/50 text-sm">App screenshot coming soon</p>
              </div>
            </div>
          </div>
        </Container>
